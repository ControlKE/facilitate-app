<template>
	...
	<!--Page Title-->
    <section class="page-title" :style="{ backgroundImage: `url(${cmsValue('gallery', 'hero', 'background_image_url', '/frontend/images/background/3.jpg')})` }">
    	<div class="auto-container">
        	<h2>{{ cmsValue('gallery', 'hero', 'headline', 'Our Gallery') }}</h2>
            <ul class="page-breadcrumb">
            	<li><a href="/">home</a></li>
                <li>{{ cmsValue('gallery', 'hero', 'headline', 'Our Gallery') }}</li>
            </ul>
        </div>
    </section>
    <!--End Page Title-->
    	...
    	<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_1_url', '/frontend/images/gallery/11.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_1_url', '/frontend/images/gallery/11.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_2_url', '/frontend/images/gallery/12.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_2_url', '/frontend/images/gallery/12.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_3_url', '/frontend/images/gallery/13.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_3_url', '/frontend/images/gallery/13.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_4_url', '/frontend/images/gallery/14.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_4_url', '/frontend/images/gallery/14.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_5_url', '/frontend/images/gallery/15.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_5_url', '/frontend/images/gallery/15.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_6_url', '/frontend/images/gallery/16.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_6_url', '/frontend/images/gallery/16.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_7_url', '/frontend/images/gallery/17.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_7_url', '/frontend/images/gallery/17.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_8_url', '/frontend/images/gallery/18.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_8_url', '/frontend/images/gallery/18.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
				...
				<div class="gallery-item col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<figure class="image-box">
							<img :src="cmsValue('gallery', 'content', 'image_9_url', '/frontend/images/gallery/19.jpg')" alt="">
							<!--Overlay Box-->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<router-link to="/gallery" class="link"><span class="icon fa fa-link"></span></router-link>
										<a :href="cmsValue('gallery', 'content', 'image_9_url', '/frontend/images/gallery/19.jpg')" data-fancybox="gallery-2" data-caption="" class="link"><span class="icon fa fa-search"></span></a>
									</div>
								</div>
							</div>
						</figure>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                    <div class="footer-widget newsletter-widget">
										...
										<div class="logo">
											<a :href="footerCqcHref()" target="_blank" rel="noopener"><img :src="footerValue('cqc_badge_image_url', '/frontend/images/CQC rating.jpg')" alt="CQC rating" /></a>
										</div>
